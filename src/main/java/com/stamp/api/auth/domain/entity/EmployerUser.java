...
public class EmployerUser {
    ...
    private EmployerUser(@Nullable OAuthId oauthId, String name, String email, String password, String contact) {
    ...
    public static EmployerUser of(String name, String email, String password, String contact) { // 기본 사용자 팩토리 메소드 패턴
        return new EmployerUser(null, name, email, password, contact);
    }

    public static EmployerUser of(
            OAuthId oauthId, String name, String email, String password, String contact) { // 소셜 로그인 사용자 팩토리 메소드 패턴
