...
public class EmployeeAuthorizationServiceImpl implements EmployeeAuthorizationService {
  ...
  /** Public Method 로그인 한 유저의 타입이 Employee가 맞는지 체크 아니라면 throw Exception */
  @Override
  ...
  /**
   * Public Method 1. 로그인 한 유저가 Employee 타입이 맞는지 체크 2. 유저가 storeId의 store에 소속되어있는지 체크 아니라면 throw
   * Exception
   */
  @Override
