...
public class EmployeeAttendanceServiceImpl implements EmployeeAttendanceService {
    ...
    public List<AttendanceRes> getAttendancesForMonth(LocalDate firstDate, UserDetails userDetails) {
        ...
        Employee employee = employeeRepository.findById(employeeId).orElseThrow(
                () ->
                        new DomainException(EmployeeErrorCode.EMPLOYEE_NOT_FOUND, "EmployeeAttendanceServiceImpl.getAttendanceForMonth"));
    ...
    public List<AttendanceRes> getAttendancesForDay(LocalDate firstDate, UserDetails userDetails) {
        ...
        Employee employee = employeeRepository.findById(employeeId).orElseThrow(
                () ->
                        new DomainException(EmployeeErrorCode.EMPLOYEE_NOT_FOUND, "EmployeeAttendanceServiceImpl.getAttendancesForDay"));
        Long storeId = employee.getStore().getId();
