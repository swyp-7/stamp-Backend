...
public class QRManageServiceImpl implements QRManageService {
    ...
    public byte[] createQRCode(Long storeId) {
        ...
        QRAuthCode qrAuthCode = authCodeRepository.findByStoreId(storeId).orElse(
                QRAuthCode.of(storeId,
                        authCode)
        );
    ...
    public byte[] getQRCode(Long storeId) {
        ...
        QRAuthCode qrAuthCode = authCodeRepository.findByStoreId(storeId).orElseThrow(
                () ->
                        new DomainException(QRCodeErrorCode.QR_NOT_EXIST_ERROR,
                                "QRManageServiceImpl.getQRCode"));
