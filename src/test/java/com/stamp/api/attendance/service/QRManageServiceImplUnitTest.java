...
public class QRManageServiceImplUnitTest {
    ...
    @Mock
    private QRAuthCodeRepository authCodeRepository;

    @InjectMocks
    private QRManageServiceImpl qrManageService;
    ...
    public void createQRCode_UpdateExistingAuthCode_Test() {
        ...
        when(authCodeRepository.findByStoreId(storeId))
                .thenReturn(Optional.of(existingAuthCode));
    ...
    public void checkAuthCode_Success_Test() {
        ...
        when(authCodeRepository.findByStoreId(storeId))
                .thenReturn(Optional.of(authCodeEntity));
